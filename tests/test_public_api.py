...
EXPORT_ORIGINS: dict[str, str] = {
    ...
    "AnnularProfile": "connection_types",
    ...
    "Colour": "colour",
    "ConnectionContact": "inspection",
    "ConnectionFeature": "connection_types",
    "ConnectionFreedom": "connection_types",
    "ConnectionGraphEdge": "inspection",
    "ConnectionGraphs": "inspection",
    "ConnectionKind": "connection_types",
    "ConnectionMetadataCoverage": "connection_metadata",
    "ConnectionMetadataReport": "connection_metadata",
    "ConnectionMultigraph": "inspection",
    "ConnectionProvenance": "connection_types",
    "ConnectionResidual": "connection_types",
    "ConnectionRole": "connection_types",
    "ConnectionSource": "connection_types",
    "ConnectionStatus": "connection_types",
    "CylindricalCaps": "connection_types",
    "CylindricalProfile": "connection_types",
    "CylindricalSection": "connection_types",
    "Diagnostic": "diagnostics",
    "DiagnosticCode": "diagnostics",
    "DownloadPlan": "library_setup",
    "FingerProfile": "connection_types",
    "GenericBounds": "connection_types",
    "GenericBoundsKind": "connection_types",
    "GenericMatch": "connection_types",
    "GenericPlacement": "connection_types",
    "GenericProfile": "connection_types",
    "Group": "pieces",
    "Identity": "geometry",
    ...
    "LDCadShadowLibrary": "connection_metadata",
    ...
    "PartCategory": "parts",
    "PartCompatibility": "connection_types",
    ...
    "SectionShape": "connection_types",
    "Severity": "diagnostics",
    "SkippedGeometry": "model_summary",
    "SkippedOccurrenceGeometry": "inspection",
    "SnapCandidate": "inspection",
    "SnapTransform": "connection_types",
    "StudContact": "inspection",
    "StudReference": "part_geometry_types",
    "StudioConnectionLibrary": "connection_studio",
    ...
    "angular_alignment_within": "connection_types",
    "bill_of_materials": "bom",
    "bounds_gap": "inspection",
    "connection_residual": "connection_types",
    "connections_compatible": "connection_types",
    ...
    "snap_transform": "connection_types",
}
