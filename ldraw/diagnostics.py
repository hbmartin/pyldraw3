...
class DiagnosticCode(StrEnum):
    ...
    CONNECTION_UNSUPPORTED_RECORD = "connection.unsupported_record"
    CONNECTION_UNSUPPORTED_OPTION = "connection.unsupported_option"
    CONNECTION_INVALID_OPTION_VALUE = "connection.invalid_option_value"
    # Compatibility name retained for callers predating the specific codes.
    CONNECTION_METADATA_INVALID = "connection.invalid_option_value"
    CONNECTION_MISSING_REQUIRED_OPTION = "connection.missing_required_option"
    CONNECTION_INCLUDE_NOT_FOUND = "connection.include_not_found"
    CONNECTION_INCLUDE_CYCLE = "connection.include_cycle"
    CONNECTION_FEATURE_CONFLICT = "connection.feature_conflict"
    CONNECTION_INVALID_TRANSFORM = "connection.invalid_transform"
    CONNECTION_INVALID_GRID = "connection.invalid_grid"
